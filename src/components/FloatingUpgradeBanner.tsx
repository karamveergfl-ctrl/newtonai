...
export function FloatingUpgradeBanner() {
  ...
  const handleDismiss = () => {
    ...
    // Wait for exit transition before updating state
    setTimeout(() => {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-20 md:bottom-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-lg transition-all duration-300 ease-out",

...
export const LectureRecorder = ({
  ...
  return <div className="w-full h-full">
      <div className="relative border-2 border-dashed rounded-2xl p-12 text-center transition-all duration-300 backdrop-blur-sm border-border bg-card/50 hover:border-primary/50 min-h-[320px] h-full flex items-center justify-center">

...
const PUBLIC_ROUTES = ["/", "/auth", "/onboarding", "/pricing", "/about", "/contact", "/privacy", "/terms", "/refund", "/faq", "/features", "/how-it-works", "/blog", "/guides", "/enterprise", "/compare", "/ai-for-students", "/ai-study-assistant", "/ai-notes-generator", "/pdf-study-tool", "/ai-quiz-generator", "/ai-flashcard-generator", "/exam-preparation-ai", "/about-newtonai-for-ai", "/pitch-deck"];

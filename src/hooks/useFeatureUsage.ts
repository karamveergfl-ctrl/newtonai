...
const FREE_LIMITS: Record<string, { limit: number; unit: "per_day" | "per_month" | "minutes_per_month" }> = {
  ...
  ai_flashcards: { limit: 3, unit: "per_month" },
  ai_quiz: { limit: 3, unit: "per_month" },
  pdf_summarizer: { limit: 5, unit: "per_month" },
  video_summarizer: { limit: 3, unit: "per_month" },
...
const PRO_LIMITS: Record<string, { limit: number; unit: "per_day" | "per_month" | "minutes_per_month" }> = {
  ...
  ai_flashcards: { limit: -1, unit: "per_month" },
  ai_quiz: { limit: -1, unit: "per_month" },
  pdf_summarizer: { limit: -1, unit: "per_month" },
  video_summarizer: { limit: -1, unit: "per_month" },
...
export const FEATURE_LABELS: Record<string, { label: string; icon: string }> = {
  ...
  ai_flashcards: { label: "AI Flashcards", icon: "🃏" },
  ai_quiz: { label: "AI Quiz", icon: "❓" },
  pdf_summarizer: { label: "PDF Summarizer", icon: "📄" },
  video_summarizer: { label: "Video Summarizer", icon: "🎬" },

...
import { Loader2, Mail, Eye, EyeOff, BookOpen, Brain, Layers, FileText, Sparkles, Phone } from "lucide-react";
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-12 pl-12 pr-10 bg-background border-border"
                  />
              ...
              {otpSent && (
                ...
                >
                  ...
                  <Input
                    ...
                    required
                    disabled={loading}
                    className="h-12 bg-background border-border text-center text-lg tracking-widest"
                    maxLength={6}
                  />
                  <button
                    type="button"

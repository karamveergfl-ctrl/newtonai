...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "best-study-techniques-engineering",
    title: "Best Study Techniques for Engineering Students",
    description: "Proven study strategies tailored for engineering coursework, from problem-based learning to collaborative study groups and AI-assisted revision.",
    category: "Study Tips",
    readTime: "9 min read",
    publishedDate: "2026-02-10",
  },
  {
    slug: "ai-flashcards-vs-traditional",
    title: "AI Flashcards vs Traditional Flashcards: A Detailed Comparison",
    description: "An in-depth comparison of AI-generated and hand-made flashcards covering effectiveness, time investment, personalization, and learning outcomes.",
    category: "AI Tools",
    readTime: "8 min read",
    publishedDate: "2026-02-08",
  },
  {
    slug: "top-mistakes-students-make-studying",
    title: "Top 10 Mistakes Students Make While Studying",
    description: "Identify the most common study mistakes that waste time and hurt grades, plus actionable strategies to fix each one using modern learning science.",
    category: "Study Tips",
    readTime: "10 min read",
    publishedDate: "2026-02-05",
  },
  {
    slug: "how-ai-improves-pdf-studying",
    title: "How AI Improves Studying From PDFs",
    description: "Discover how AI transforms passive PDF reading into active learning through intelligent chat, automatic summaries, and targeted study material generation.",
    category: "AI Tools",
    readTime: "8 min read",
    publishedDate: "2026-02-02",
  },
  {
    slug: "productivity-techniques-students",
    title: "Productivity Techniques Every Student Should Know",
    description: "Master time management and focus strategies including the Pomodoro Technique, time blocking, and digital tools that help students accomplish more in less time.",
    category: "Productivity",
    readTime: "9 min read",
    publishedDate: "2026-01-28",
  },
  {
    slug: "educational-technology-insights-2026",
    title: "Educational Technology Trends Students Should Know in 2026",
    description: "Explore the latest EdTech innovations from AI tutors and adaptive learning platforms to immersive study tools reshaping how students learn in 2026.",
    category: "EdTech",
    readTime: "9 min read",

...
import { DECK_SLIDES } from "@/pitch-deck/slides";
...
export default function InvestorPitchDeck() {
  ...
  const { Component, title } = DECK_SLIDES[current];
  ...
  return (
    <>
      <Helmet>
        ...
        <title>NewtonAI — Investor Pitch Deck</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="description" content="NewtonAI investor pitch deck — market, product and financials." />
      </Helmet>
      <div

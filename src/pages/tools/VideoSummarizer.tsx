...
const VideoSummarizer = () => {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `${videoTitle.replace(/[^a-z0-9]/gi, "-")}-summary.md`;
    a.click();
      ...
      <div className="min-h-screen bg-background p-6">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-display font-bold tracking-tight">Video Summarizer</h1>
              ...
              <Card className="border-border/50 shadow-lg overflow-hidden">
                <CardHeader className="flex flex-row items-center justify-between border-b border-border/50 bg-muted/30">
                  <div>
                    ...
                    {videoTitle && (
                      <CardDescription className="font-sans">{videoTitle}</CardDescription>
                    )}
                  </div>
